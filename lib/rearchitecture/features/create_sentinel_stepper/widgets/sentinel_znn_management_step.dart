...
/// ZNN management step for the sentinel creation flow.
class SentinelZnnManagementStep extends StatelessWidget {
  /// Creates a [SentinelZnnManagementStep].
  const SentinelZnnManagementStep({
