...
/// Plasma check step for the pillar creation flow.
class PillarPlasmaCheckStep extends StatelessWidget {
  /// Creates a [PillarPlasmaCheckStep].
  const PillarPlasmaCheckStep({
