...
class ActiveSentinelsPopulated extends StatelessWidget {
  /// Creates an [ActiveSentinelsPopulated].
  const ActiveSentinelsPopulated({required this.sentinelInfoList, super.key});
