...
/// The state class for the `BalanceDashboardCubit`, extending `DashboardState`
/// and managing detailed account balance data.
///
/// `BalanceDashboardState` holds an `AccountInfo` object representing the
/// balance information of a single account.
/// This state is used by the `BalanceDashboardCubit` to track detailed balance
/// data.
class BalanceDashboardState extends DashboardState<AccountInfo> {
  ...
  /// Creates a copy of the current `BalanceDashboardState` with optional new
  ...
  ///
  /// Returns:
  /// - A new instance of `BalanceDashboardState` with updated values or the
  /// current ones if none are provided.
  @override
