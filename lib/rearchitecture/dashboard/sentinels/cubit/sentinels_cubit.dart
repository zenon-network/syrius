...
///
/// This cubit extends `DashboardCubit<SentinelInfoList>`, using a
/// `SentinelInfoList` object to represent the list of active sentinels
...
class SentinelsCubit extends DashboardCubit<SentinelInfoList, SentinelsState> {
  ...
  ///
  /// This method calls the Zenon SDK's `getAllActive()` method to retrieve the
  /// list of active sentinels. The fetched data is returned as a
  /// `SentinelInfoList`.
  ///
  /// Throws:
