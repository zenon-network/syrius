...
/// the executable that was used to register the scheme with the URL as the
/// first argument passed to the executable.
///
/// If a protocol is already registered for the given scheme, this function will
/// attempt to overwrite the previous handler with the current executable
/// information. However, note that depending on process permissions, this
/// operation may be disallowed by the underlying platform.
///
...
/// those elements must contain the literal value `%s` to denote the URL to
/// open.
...
///
/// Note that this will unregister a protocol by scheme regardless of which
/// process had registered it. Unregistering a scheme that was not registered
/// by this application is undefined and depends on platform-specific
/// restrictions.
