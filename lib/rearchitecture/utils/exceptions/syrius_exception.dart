...
class SyriusException implements Exception {
  ...
  ///
  /// The classes that extend from [SyriusException] should also add to the
  /// [Map] generated by the [toJson] method a key - 'runtimeType' - with the
  /// name of the class as a value. This is needed for serialization and
  /// deserialization; in the case of [TimerState], instead of using the
  /// concrete child classes, like [NoActiveStakingEntriesException], the
  /// parent [SyriusException] is used as a type for the error inside the state
